...
description: "Use to generate a verification skill for a repository that drives the real application through user paths. Triggers on: create-verification-skill, make a control skill, or when a project has no scripted way to prove UI, CLI, or service behavior."
---
