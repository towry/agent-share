...
Start by finding the relevant code. Search directories and files, search for key symbols, then read the actual implementation. Don't guess from names. Read the code.
