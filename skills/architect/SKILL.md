---
name: architect
description: "Use to define types, signatures, and module structure before writing code, then adhere to that sketch during implementation. Triggers on: architect, design this, or a non-trivial change where writing code directly would lock in the shape."
---
...
Use the `architect-runners` list from setup-pstack `references/model-roles.md` (defaults `judgment`, `instruction-following`, `fast-code`, `extra-voice`).
