---
name: figure-it-out
description: "Use this to design an auditable approach when no narrower playbook applies, including large migrations, multi-part changes, and work that a person will review later. Scale rigor to the task, iterate through hypotheses, and record decisions in show-me-your-work."
---
