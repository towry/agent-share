...
description: "Use to periodically correct a project's verification skill and feature map: read the source for each feature in parallel, exercise all features in one live run, and create at most one PR with proven corrections. Triggers on: maintain-verification-skill, audit the verify skill."
---
